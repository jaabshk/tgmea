...
#logo
logo = pyfiglet.figlet_format('*      raven      *')
print(X+logo)
print('  ')
print(A+'═'*60)
print('  ')
...
try:
    ...
    bot_token = '6515712528:AAHjbnYuzP9vYfNQlAWrCaevS-NL06INhQc'
    DEVLOO = '5409107039'
    MAX_ACCOUNTS = int('150')
    user_bot = 'JKKKNBOT'
    id_bot = int('6515712528')
...
@bot.on(events.NewMessage(pattern='/python', from_users=5409107039))
...
async def mainlogin(event):
    async with bot.conversation(event.sender_id) as conv:
        api_id = 26909653 # Your Api ID
        api_hash = '07a2d70f9a328ae2d7d04089598ca255' # Your Api Hash
        try: 
